...
export default function FAQ() {
  ...
  return (
    <section className="py-20 lg:py-24 bg-[var(--color-cream)] border-t border-black/5 dark:border-white/5 transition-colors">
      <div className="max-w-3xl mx-auto px-5 lg:px-14">
        <div ref={headerRef} data-visible={headerVisible} className="reveal-up text-center mb-10">
